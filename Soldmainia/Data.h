...
struct Einheit
{
	...
	unsigned short int Große;
	bool Einsatzbereit;

	Einheit( unsigned short int hp = 100, unsigned short int moral = 10, unsigned short int starke = 1, bool einsatzbereit = true, unsigned short int Große=1)
	{
		HP = hp;
		Moral = moral;
		Starke = starke;
