...
View::View(std::shared_ptr<Data> data) : Eingabe(0), ViewIn(data) {}
...
void View::addBenarichtigung(std::string const& benarichtigungsText,
...
void View::printGebaeudeStats(GebaeudeUpgradeStats const& stats,
...
void View::ausgabe(Menus aktuellesMenu,
