...
class Scoutbuero : public Gebaeude {
     public:        
      ...
      /*
       ...
       zurück Zu Beachten: Die Funktion ist in gebaude als virtuell deklarirt
       */
      ...
      /*
       Name: Annehmen
       param: keine
       Aufgabe: Die  Funktion fuegt das EM hinzu und stellt die Aufgaben
       anzige auf Informationtext um Anzeige Retrun: keine
       */
      void annehmenDerEinheit();

      /*
       Name: Ablehnen
       param: keine
       Aufgabe: Die Funktion loescht das EM und stellt die Aufgaben anzige auf
       Informationtext um Anzeige Retrun: keine
       */
      void ablehnenDerEinheit();
      ...
      /*
       ...
       param: keine
       Aufgabe: Die Funktion modifiziert iRangmin, so das die Em`s die
       gefunden werden einen hoheren Rang haben und passt den Kontostand sowie
       die Kacheln an Retrun: keine
       */
