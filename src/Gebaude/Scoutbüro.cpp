...
void Scoutbuero::beendenDerAusfuhrung()
{
	...
	Daten->getKacheln(12).ButtonHinzufuegen(35, 400, 200, 30, 5, "Annehmen",
	...
	Daten->getKacheln(12).ButtonHinzufuegen(35, 450, 200, 30, 6, "Ablehnen",
			*Daten->getFont(), sf::Color::Black, sf::Color(100, 100, 100),
			sf::Color(255, 150, 0), sf::Color::White,
			Data->getKacheln(12).getGroese().x,
			Data->getKacheln(12).getGroese().y);
...
void Scoutbuero::annehmenDerEinheit()
{
	...
	Daten->getKacheln(12).ButtonHinzufuegen(35, 450, 200, 30, 1, "Starten",
			*Daten->getFont(), sf::Color::Black, sf::Color(100, 100, 100),
