...
void Traningszentrum::beendenDerAusfuhrung()
{
	...
	ssText
			<< "Neue Einheit Trainieren\nDie Einheit erhalt\nErfahrungspunkte was sie\nStarker macht und\ndie Erfolgsraten in\nEinsatzen verbessert.\nDie Menge der\nErfahrungspunkte hangt von\nder Dauer ab";

	Daten->getKacheln(16).neueAnzeige(ssText.str(), 200, 99, 1, 1);	// Akktualiesieren des Textes
	//// Hinzuf�gen aller Notiger Buttens 
	Daten->getKacheln(16).ButtonHinzufuegen(45, 450, 200, 30, 5,
			"Lange Tranings Einheit", *Daten->getFont(), sf::Color::Black,
			sf::Color(100, 100, 100), sf::Color(50, 50, 50), sf::Color::White,
			Data->getKacheln(16).getGroese().x,
			Data->getKacheln(16).getGroese().y);
	Daten->getKacheln(16).ButtonHinzufuegen(45, 350, 200, 30, 6,
			"Kurze Trainings Einheit", *Daten->getFont(), sf::Color::Black,
			sf::Color(100, 100, 100), sf::Color(50, 50, 50), sf::Color::White,
			Data->getKacheln(16).getGroese().x,
			Data->getKacheln(16).getGroese().y);
	Daten->getKacheln(16).ButtonHinzufuegen(45, 400, 200, 30, 7,
			"Mittlere trainings Einheit", *Daten->getFont(), sf::Color::Black,
			sf::Color(100, 100, 100), sf::Color(50, 50, 50), sf::Color::White,
			Data->getKacheln(16).getGroese().x,
			Data->getKacheln(16).getGroese().y);
